...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Kossel Mini + E3D-v6
  #define  DEFAULT_Kp 35.18
  #define  DEFAULT_Ki 3.73
  #define  DEFAULT_Kd 82.97
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  //Kossel mini kapton heater into 2mm aluminium
  #define  DEFAULT_bedKp 637.62
  #define  DEFAULT_bedKi 120.11
  #define  DEFAULT_bedKd 846.20
...
// My current params :
// M665 L217.50 R104.60 H236.70 S200.00 B72.00 X0.00 Y0.00 Z0.00
// M666 X0.00 Y-0.10 Z-0.60
  ...
  #define DELTA_DIAGONAL_ROD 217.5
  ...
  #define DELTA_HEIGHT 236.7 // get this value from auto calibrate - use G33 C-1 at 1st time calibration
  ...
  #define DELTA_DIAGONAL_ROD_TRIM_TOWER {0.36, 0, 0.36}
